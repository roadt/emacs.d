...
(defcustom quickrun-timeout-seconds 300
...
(defvar quickrun/language-alist
  '(("c/gcc" . ((:command . "gcc")
    ...
    ("ruby" . ((:command . "ruby default do ruby") (:compile-only . "%c -wc %s")
    ...
    ("scheme/csi" . ((:command . "csi")
		     (:description . "Run Scheme file with csi(Chicken)")))
